        ...
        <>
                            ...
                            {image
                                ...
                                : !isNested &&
                                  (!marketHasItems || marketLoading ? (
                                      ...
                                      <ErrorOutlineIcon style={{ maxWidth: '100%', maxHeight: '100%', color: 'red' }} />
                                  ))}
                        </div>
            ...
            >
                ...
                {(!group || isNested) && change < -50 && (
                    <LightTooltip placement="top" title={`-x${Math.floor(1 / ((val / profit) * 0.0099 * change))}`}>
                ...
                {(!group || isNested) && change > 100 && (
                    <LightTooltip placement="top" title={`x${Math.floor((val / profit) * 0.0101 * change)}`}>
                        <div className={classes.indicator}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="#61e024"
