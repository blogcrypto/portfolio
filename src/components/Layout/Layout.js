...
function TabPanel(props) {
    ...
    return (
        ...
        <div role="tab" hidden={value !== index} id={`tab-${index}`} aria-labelledby={`tab-${index}`} {...other}>
                ...
                {spreadsheet.link ? (
                    <div className={classes.table}>
                        {!!table.columnsHidden.length && (
                            ...
                            >
                                {`${table.columnsHidden.length} ${t('hidden_columns')}`}
                            </Button>
                        )}
                        ...
                        <Grid item sm={10} md={9} lg={7} xl={6}>
                            ...
                            <Paper variant="outlined" style={{ padding: '2rem', margin: '2rem 0 0' }}>
                                ...
                                <Button
                                    ...
                                    href={
                                        i18n.language === 'ru'
                                            ? 'https://blogcrypto.info/ru/contacts'
                                            : 'https://blogcrypto.info/contacts'
                                    }
                                >
                                    {t('contacts_button')}
                                </Button>
